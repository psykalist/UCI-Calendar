...
const CACHE_NAME = 'uci-calendar-v48';
...
self.addEventListener('fetch', event => {
  ...
  const isData = url.pathname.endsWith('data.json') || url.pathname.endsWith('pcs_stats.json') || url.pathname.endsWith('rider_profiles.json');
